...
(32, 'ชวนัน หารกล้า', 'พิมพ์เอกสาร', 'เชิงบริการ', 'พิมพ์งาน / ถ่ายเอกสาร', 1, 2561, NULL, NULL, 'สามารถใช้ Microsoft office ได้,ตรงต่อเวลา', '2018-10-06', 'X', NULL, 8, NULL, '1', 'ศูนย์บรรณาสารเเละสื่อการศึกษา', '', 915586987, NULL, 147852);
...
(4, '58142597', 58142597, '123456', 1, NULL),
...
(58112233, 'นายจิตใจ เเซ่ตั้ง', 'จัดเตรียมเอกสาร', 'เเพทย์ศาสตร์', '2.00', '0887854125', '581128484125', '37/5', '1', 'หนองหง', '-', 'นาหลวงเสน', 'พัทลุง', 80145, 3000, 'เเก้ไข', 'ลอง', '1', 'M', 'พุทธ', 'ไทย', '', '', '2', '', '', '', NULL, '', 0, 1),
(58112848, 'นายชวนัท ชาญอาวุธ', 'ขนย้ายสิ่งของ', 'เทคโนโลยีสารสนเทศ', '2.00', '51615', '1314125', '153', NULL, NULL, NULL, 'หงกมๆบ', 'วืย', NULL, 5, 'หฟืดยแยื', '', '2', 'ส', 'สืย', NULL, 'สืสส', 'สืืยืย', '1', 'สืสืย', 'สืืืยบ', 'สืสยย', NULL, '', 0, 1),
(58118696, 'นายภาณุพงศ์ จันทมุณี', 'จัดชั้นวางหนังสือ', 'เทคโนโลยีสารสนเทศ', '4.00', '0915241383', '9876543211', '107', '5', 'ชะมาย', '-', 'ทุ่งสง', 'นครศรีธรรมราช', 80110, 25000, 'สามารถใช้ microsoft ได้ดี', 'มีเงินไม่เพียงพอต่อค่าใช้จ่าย', '0', 'M', 'พุทธ', 'ไทย', 'panupong_963@hotmail.com', 'ดี', '2', '0622426715', '8281464785003', 'panupong jantamunee', '0', '', 12345678, 3),
(58122235, 'นางสาวสุรีพร สุขะวัลลิ', 'จัดพิมพ์เอกสาร', 'เทคโนโลยีสารสนเทศ', '3.99', '0622426715', '9875642311', '107 ม.5 ต.ชะม้อย', NULL, NULL, NULL, 'เมือง', 'นครศรีธรรมราช', NULL, 25633, 'มีความสามารถด้าน microsoft', 'ที่บ้านไม่มีเงินส่ง', '1', '-', '--', NULL, 'Panda@hotmail.com', '-', '1', '-', '-', '-', NULL, '', 12345678, 32),
(58142597, 'นายบุรัสกร อิศรพันธุ์', 'จัดชั้นหนังสือ', 'เทคโนโลยีสารสนเทศศาสตร์', '4.00', '0613670797', '7894561233', '2114', '-', 'ท่าวัง', 'ป่าโล่ง', 'เมือง', 'นครศรีธรรมราช', 80000, 25000, 'มีความสามารถด้าน microsoft', 'ทางบ้านยากจน', '1', '-', 'ไทย', 'ไทย', 'ford_buradsagorn@hotmail.com', '----', '1', '----', '----', '-----', NULL, '', 0, 32);
...
--
ALTER TABLE `job`
  MODIFY `Job_ID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเลขที่งาน', AUTO_INCREMENT=33;
