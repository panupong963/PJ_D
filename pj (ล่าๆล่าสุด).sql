...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2018 at 08:59 PM
...
(87654321, 'ชินปกร  เเก้วจัน', '', 'ศูนย์บรรณาสารเเละสื่อการศึกษา', '0874125896'),
(741852963, 'มนเสก จันเเก้ว\r\n', '', 'ศูนย์บรรณาสารเเละสื่อการศึกษา', '0812365844');

-- --------------------------------------------------------

--
-- Table structure for table `facultyname`
--
...
--
-- Dumping data for table `facultyname`
--

INSERT INTO `facultyname` (`id_F`, `FACULTYNAME`) VALUES
(1, 'การจัดการ'),
(2, 'พยาบาลศาสตร์'),
(3, 'รัฐศาสตร์และนิติศาสตร์'),
(4, 'วิทยาศาสตร์'),
(5, 'วิศวกรรมศาสตร์และทรัพยากร'),
(6, 'ศิลปศาสตร์'),
(7, 'สถาปัตยกรรมศาสตร์และการออกแบบ'),
(8, 'สหเวชศาสตร์'),
(9, 'สาธารณสุขศาสตร์'),
(10, 'สารสนเทศศาสตร์'),
(11, 'เทคโนโลยีการเกษตร'),
(12, 'เภสัชศาสตร์'),
(13, 'แพทยศาสตร์');
...
(1, 'จารุวรรณ บัวเเย้ม', 'ขนของ', 'ธุรการ', 'ขนของ', 1, 2561, 8, '', 'เเข็งเเรง', '2018-09-08', 'Y', '2018-09-30', 10, 'ทำงานดี', '1', 'ศูนย์บรรณาสารเเละสื่อการศึกษา', '', 955848786, 'อาคารวิชาการ5', 12345678),
(2, 'จิตรา การแก้ว', 'ถ่ายเอกสาร', 'บริการ', 'ถ่ายเอกสารต่างๆ', 1, 2561, NULL, '', 'เเข็งเเรง', '2018-09-22', 'M', '2018-09-29', 20, 'ทำงานดี', '1', 'ศูนณ์เครื่องมือวิทยาศาสตร์และเทคโนโลยี', '', 622426715, 'อาคารวิชาการ3', 12345678),
(3, 'อามิต ก้านเเก้ว', 'ประกอบคอมพิวเตอร์', 'บริการ', 'ซ่อมคอม', 1, 2561, NULL, '', 'เเข็งเเรง มีความรู้ทางด้านคอมพิวเตอร์', '2018-09-22', 'M', '2018-09-29', 20, 'ทำงานดี', '2', 'ศูนณ์เครื่องมือวิทยาศาสตร์และเทคโนโลยี', 'ไม่ผ่าน', 622426715, 'อาคารวิชาการ7', 12345678),
(26, 'ชวนัน หารกล้า', 'จัดการเอกสาร', 'เชิงวิชาการ', 'จัดเอกสาร,พิมพ์งาน / ถ่ายเอกสาร', 1, 2560, NULL, NULL, 'มีความขยัน,มีความรับผิดชอบ', '2018-10-03', 'F', NULL, 10, NULL, '0', 'ศูนย์บรรณาสารเเละสื่อการศึกษา', '', 915586987, NULL, 147852),
(27, 'ชวนัน หารกล้า', 'จัดการเอกสาร', 'เชิงวิชาการ', 'จัดเอกสาร,พิมพ์งาน / ถ่ายเอกสาร', 1, 2561, NULL, NULL, 'มีความขยัน,มีความรับผิดชอบ', '2018-10-03', 'F', NULL, 10, NULL, '0', 'ศูนย์บรรณาสารเเละสื่อการศึกษา', '', 915586987, NULL, 147852);
...
INSERT INTO `student` (`student_code`, `STUDENTNAME`, `FACULTYNAME`, `PROGRAMNAME`, `GPAX`, `PARENTPHONENO`, `BANKACCOUNT`, `HOMEADDRESS1`, `Moo`, `district`, `Road`, `HOMEDISTRICT`, `PROVINCENAME`, `Zip_code`, `Expenses`, `Talent`, `Necessary`, `Re_status`, `STUDENTSEX`, `RELIGIONNAME`, `Nationality`, `STUDENTEMAIL`, `Status`, `Bank_Name`, `Tele_Number_update`, `Bank_id_update`, `Bank_Name_update16`, `Career_History`, `Reason_ST`, `OFFICERID`, `Job_ID`) VALUES
(58112233, 'จิตใจ เเซ่ตั้ง', 'เทคนิคการเเพทย์', 'พยาบาล', '2.00', '0887854125', '581128484125', '37/5', '1', 'หนองหง', '-', 'นาหลวงเสน', 'พัทลุง', 80145, 3000, 'เเก้ไข', 'ลอง', '1', 'M', 'พุทธ', 'ไทย', '', '', '2', '', '', '', NULL, '', 0, 1),
(58112848, 'นายชวนัท ชาญอาวุธ', 'ศิลปศาสตร์', 'ิ่สิ้บ่ลางส่ยนี', '2.00', '51615', '1314125', '153', NULL, NULL, NULL, 'หงกมๆบ', 'วืย', NULL, 5, 'หฟืดยแยื', '', '2', 'ส', 'สืย', NULL, 'สืสส', 'สืืยืย', '1', 'สืสืย', 'สืืืยบ', 'สืสยย', NULL, '', 0, 1),
(58118696, 'ภาณุพงศ์ จันทมุณี', 'สารสนเทศศาสตร์	', 'เทคโนโลยีสารสนเทศ', '4.00', '0915241383', '828147852369', '107', '5', 'ชะมาย', '-', 'ทุ่งสง', 'นครศรีธรรมราช', 80110, 15000, 'กินเก่ง', 'เดือนร้อนทางการเงิน', '0', 'M', 'พุทธ', 'ไทย', 'panupong_963@hotmail.com', 'ดี', '2', '0622426715', '8281464785003', 'panupong jantamunee', '0', '', 12345678, 25),
(58122235, 'นางสาวสุรีพร สุขะวัลลิ', 'สารสนเทศศาสตร์	', 'เทคโนโลยีสารสนเทศ', '3.99', '0622426715', '', '107 ม.5 ต.ชะม้อย', NULL, NULL, NULL, 'เมือง', 'นครศรีธรรมราช', NULL, 0, '', '', '1', '-', '--', NULL, 'Panda@hotmail.com', '-', '1', '-', '-', '-', NULL, '', 12345678, 2),
(58142597, '----', 'พยาบาลศาสตร์', '--------', '4.0', '----', '-----', '------', NULL, NULL, NULL, '---------', '-------', NULL, 1, '-ส้น', '', '1', '-', '----', NULL, '----', '----', '2', '----', '----', '-----', NULL, '', 0, 2);
...
(375, '2018-09-30', 8, 9, 0, 0, '1', 6000, NULL, NULL, 1, NULL, '858', NULL, NULL, NULL, NULL, 58118696),
(376, '2018-10-01', 8, 9, 30, 0, '1', 90, NULL, NULL, 1, NULL, '74', NULL, NULL, NULL, NULL, 58118696),
(377, '2018-10-10', 8, 9, 0, 10, '1', 70, NULL, NULL, 25, NULL, 'ลอง', NULL, NULL, NULL, NULL, 58118696);
...
--
-- AUTO_INCREMENT for table `facultyname`
--
ALTER TABLE `facultyname`
  MODIFY `id_F` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `job`
--
ALTER TABLE `job`
  MODIFY `Job_ID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเลขที่งาน', AUTO_INCREMENT=28;
...
--
ALTER TABLE `work`
  MODIFY `Work_ID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการทำงาน', AUTO_INCREMENT=379;
