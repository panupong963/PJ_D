...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2018 at 02:43 PM
...
('1', '1', '2561', NULL, '2018-11-01', '2018-12-31', 'เริ่มปฏิบัติงาน', NULL),
...
INSERT INTO `job` (`Job_ID`, `job_name_ss`, `Job_Name`, `Category`, `Job_description`, `term`, `year`, `Remaining`, `STUDENTCODE`, `Attribute_applicants`, `Frist_date`, `Sex`, `Working_time`, `Receiving_number`, `Job_history`, `Job_status`, `Department`, `Contact`, `ss`, `OFFICERID`) VALUES
...
--
ALTER TABLE `job`
  MODIFY `Job_ID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเลขที่งาน', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `login`
--
ALTER TABLE `login`
  MODIFY `login_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
