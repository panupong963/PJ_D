...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2018 at 05:21 PM
...
(58112233, 'จิตใจ เเซ่ตั้ง', 'เทคนิคการเเพทย์', 'เเพทย์', '2.00', '0887854125', '581128484125', '37/5', '1', 'หนองหง', '-', 'นาหลวงเสน', 'พัทลุง', 80145, 3000, 'เเก้ไข', 'ลอง', '1', 'M', 'พุทธ', 'ไทย', '', '', '2', '', '', '', NULL, '', 0, 1),
(58112848, 'นายชวนัท ชาญอาวุธ', 'ส่่ิอไ', 'ิ่สิ้บ่ลางส่ยนี', '2.00', '51615', '1314125', '153', NULL, NULL, NULL, 'หงกมๆบ', 'วืย', NULL, 5, 'หฟืดยแยื', '', '2', 'ส', 'สืย', NULL, 'สืสส', 'สืืยืย', '1', 'สืสืย', 'สืืืยบ', 'สืสยย', NULL, '', 0, 1),
(58118696, 'ภาณุพงศ์ จันทมุณี', 'สารสนเทศศาสตร์	', 'เทคโนโลยีสารสนเทศ', '4.00', '0915241383', '828147852369', '107', '5', 'ชะมาย', '-', 'ทุ่งสง', 'นครศรีธรรมราช', 80110, 15000, 'กินเก่ง', 'เดือนร้อนทางการเงิน', '1', 'M', 'พุทธ', 'ไทย', 'panupong_963@hotmail.com', 'ดี', '2', '0622426715', '8281464785003', 'panupong jantamunee', '0', '', 12345678, 25),
...
(58142597, '----', '---------', '--------', '4.0', '----', '-----', '------', NULL, NULL, NULL, '---------', '-------', NULL, 1, '-ส้น', '', '1', '-', '----', NULL, '----', '----', '2', '----', '----', '-----', NULL, '', 0, 2);
...
--
ALTER TABLE `work`
  MODIFY `Work_ID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการทำงาน', AUTO_INCREMENT=378;
